...
<body>
	<nav>
		<div class="nav-wrapper  blue darken-4">
			<a href="#" class="brand-logo right">Agenda - Gygatech
				Informática</a>
	...
	<div class="row">
		<form class="col s12" action="alterarAgenda" method="Post">
			<div class="row">
				<div class="col s6">
					<h4 class="blue-text text-indigo">Data do Agendamento: ${data}</h4>
				</div>
				<div class="col s6">
					<h4 class="blue-text text-indigo">Cliente: ${agenda.cliente.nome}</h4>
				</div>
				<div class="row white">
					<div class="input-field col s1">
						<i class="material-icons prefix blue-text text-indigo">mode_edit</i>
						<input value="${agenda.codigo}" id="Codigo"
				...
				<div class="row white">
					<div class="input-field col s6">
						<i class="material-icons prefix blue-text text-indigo">mode_edit</i>
						<input id="Info" value="${agenda.informacoes}" name="informacoes" type="text" class="validate">
