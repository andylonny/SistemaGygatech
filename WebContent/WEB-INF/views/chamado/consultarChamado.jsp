...
<body>
	<nav>
		<div class="nav-wrapper  blue darken-4">
			<a href="#" class="brand-logo right">Consultar Chamado - Gygatech
				Informática</a>
	...
	<div class="row">
		<form class="col s12" action="consultarChamadoNome" method="Post">
			<div class="row">
				<div class="row white">
	...
	<div class="row">
		<form class="col s12" action="consultarChamadoData" method="Post">
			<div class="row">
				<div class="row white">
	...
	<div class="row">
		<form class="col s12" action="consultarChamadoStatus" method="Post">
			<div class="row">
				<div class="row white">
	...
	<div class="row">
		<form class="col s12" action="consultarChamadoTotal" method="Post">
			<div class="row">
				<div class="row white">
					<button class="btn waves-effect waves-light blue darken-4"
