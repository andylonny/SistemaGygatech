...
<body>
	<nav>
		<div class="nav-wrapper  blue darken-4">
			<a href="#" class="brand-logo right">Alterar Peça - Gygatech
				Informática</a>
	...
	<div class="row">
		<form class="col s12" action="alterarPeca" method="Post">
			<div class="row">
				<div class="row white">
					<div class="input-field col s1">
						<i class="material-icons prefix blue-text text-indigo">mode_edit</i>
						<input value="${peca.codigo}" id="Codigo"
				...
				<div class="row white">
					<div class="input-field col s6">
						<i class="material-icons prefix blue-text text-indigo">mode_edit</i>
						<input value="${peca.descricao}" id="Descricao" name="descricao" type="text" class="validate">
						<label for="Descricao">Descrição:</label>
					</div>
					<div class="input-field col s3">
						<input value="${peca.valor}" id="Valor" name="valor"  step="0.01" type="number"
