...
<body>
	<nav>
		<div class="nav-wrapper  blue darken-4">
			<a href="#" class="brand-logo right">Cadastrar Cliente - Gygatech
				Informática</a>
	...
	<div class="row">
		<form class="col s12" action="gravarCliente" method="Post">
			<div class="row">
				<div class="row white">
				...
				<div class="row white">
					...
					<div class="input-field col s1">
						<input id="UF" name="uf" type="text" class="validate"> <label
							for="UF">UF:</label>
					</div>
					<div class="input-field col s2">
				...
				<div class="row white">
					<div class="input-field col s3">
						<i class="material-icons prefix blue-text text-indigo">phone</i> <input
							id="Tel1" name="tel1" type="text" class="validate"> <label
							for="Tel1">Telefone 1:</label>
					</div>
					<div class="input-field col s3">
						<input id="Tel2" name="tel2" type="text" class="validate">
				...
				<div class="row white">
					<div class="input-field col s6">
						<i class="material-icons prefix blue-text text-indigo">email</i> <input
							id="Email" name="email" type="text" class="validate"> <label
